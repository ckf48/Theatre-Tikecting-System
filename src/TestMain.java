...
public class TestMain {
    public static void main(String [] args){
        ...
        Ticket test = new TestTicket(20);
        Ticket newT = new NewTicket(10);
        TicketSeller seller = new TicketSeller(test,1);
        TicketSeller seller1 = new TicketSeller(newT,2);
        TicketSeller seller2 = new TicketSeller(test,3);
        TicketSeller seller3 = new TicketSeller(test,4);
        Theater.getInstance().addSeller(seller);
        Theater.getInstance().addSeller(seller1);
        Theater.getInstance().addSeller(seller2);
        Theater.getInstance().addSeller(seller3);
